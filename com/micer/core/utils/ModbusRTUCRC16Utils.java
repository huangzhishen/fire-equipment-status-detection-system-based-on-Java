...
public class ModbusRTUCRC16Utils {
    ...
    {
        String request = "0103000000204412";

        byte[] data = com.google.common.io.BaseEncoding.base16().decode(request);

        int[] crc = calculateCRC(data, 0, 6);

        System.out.println(Integer.toHexString(crc[0]));
        System.out.println(Integer.toHexString(crc[1]));

        int responseSize = Integer.parseInt(request.substring(10, 12), 16);

        String hex = "0020";
        Integer x = Integer.valueOf(Integer.parseInt(hex, 16));
